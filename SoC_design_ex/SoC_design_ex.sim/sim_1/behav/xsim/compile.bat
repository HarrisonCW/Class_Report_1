...
REM
REM Generated by Vivado on Thu Aug 31 14:04:56 -0500 2023
...
echo "xvlog --incr --relax -L uvm -prj accum_t_vlog.prj"
call xvlog  --incr --relax -L uvm -prj accum_t_vlog.prj -log xvlog.log
